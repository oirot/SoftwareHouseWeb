...
public final class SQLStatemets {
	public static final String productById = "SELECT * FROM prodotto p INNER JOIN prodotto_in_vendita piv ON p.id_prodotto = piv.id_prodotto WHERE p.id = ?";
	...
	public static final String deleteProduct = "DELETE FROM prodotto_in_vendita WHERE id = ?; DELETE FROM prodotto WHERE id_prodotto = ?";
